...
@Configuration
@EnableJpaRepositories(basePackages = "com.bit.pms.repository", entityManagerFactoryRef = "entityManagerFactory",
...
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.bit.pms.model" });
